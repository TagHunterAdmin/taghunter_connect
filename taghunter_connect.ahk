...
; #include %A_ScriptDir%\ahk-autoupdate-template-main\meta.ahk
; #include *i ahk-autoupdate-template-main\compile_prop.ahk

; #include ahk-autoupdate-template-main\prod.ahk
...
; 	UAC()
; }
; #include ahk-autoupdate-template-main\update.ahk

#Requires AutoHotkey v2.0

SetWorkingDir A_ScriptDir

Application := { Name: "TagHunter Connect", Version: version }

; ; Github.latest(usr, repo)
;     ;  git := Github.latest("TagHunterAdmin", "taghunter_connect")
;     ; json_string := ObjectToString(git, 0)
;     ;     msgbox(json_string)
...
global DirPath := A_MyDocuments "\TagHunter_Connect"
global FilePath := A_MyDocuments "\TagHunter_Connect\events.csv"
...
SettingsGui(){
    ...
    ; myGui.Add("Text", "xs ys+10 BackgroundWhite vPathConfigDiv", "Chemin d'accès au dossier TagHunter Connect " A_ScriptDir) 
     myGui.Add("Text", "xs ys+10 BackgroundWhite ", "Le chemin de fichier à écrire dans Sportident Reader doit pointer sur le fichier events.csv de TagHunter Connect")
    myGui.Add("Text", "vPathEventConfigDiv", "Chemin d'accès au fichier events.csv " FilePath) 
    ...
    ; MyGui.AddPicture("w500 h300", "help_sportident_reader.png")
;  MyGui.Add("Picture", "help_sportident_reader.png", "C:\My Application.exe")
    Tab.UseTab("")
